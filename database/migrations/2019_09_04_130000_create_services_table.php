...
class CreateServicesTable extends Migration
{
    ...
    public function seed()
    {
        ...
        Service::create([
            'color' => 'orange',
            'icon' => 'fad fa-fw fa-sort-alpha-up-alt',
            'name_fr' => 'Cat 3', 'name_pt' => 'Cat 3', 'name_en' => 'Cat 3', 'name_es' => '',
            'lft' => 3,
        ]);
        Service::create([
            'color' => 'purple',
            'icon' => 'fad fa-fw fa-sort-alpha-up-alt',
            'name_fr' => 'Cat 4', 'name_pt' => 'Cat 4', 'name_en' => 'Cat 4', 'name_es' => '',
            'lft' => 4,
        ]);
        ...
        Service::create([
            'color' => '',
            'icon' => 'fad fa-fw fa-sort-alpha-up-alt',
            'name_fr' => 'Cat 5', 'name_pt' => 'Cat 5', 'name_en' => 'Cat 5', 'name_es' => '',
            'lft' => 5,
        ]);
        ...
        Service::create([
            ...
            'name_fr' => 'Intégration système de paiement (Stripe, Paypal)', 'name_pt' => 'Integração de sistemas de pagamento (Stripe, Paypal)', 'name_en' => 'Payment system integration (Stripe, Paypal)', 'name_es' => '',
            'parent_id' => 1,
            'lft' => 3,
        ]);
        Service::create([
